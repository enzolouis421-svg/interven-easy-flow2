    ...
    const response = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `Tu es un assistant IA spécialisé pour aider les artisans et techniciens. 
            Tu peux les aider avec:
            - La rédaction de rapports d'intervention
            - La création de devis professionnels
            - Des conseils techniques
            - L'organisation de leur travail
            - Des recommandations sur le matériel et les méthodes
